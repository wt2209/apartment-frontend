<template>
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <!-- search form -->
        <form method="get" class="sidebar-form" @submit.prevent="searchAll">
          <div class="input-group">
            <input type="text" name="q" class="form-control" placeholder="全局搜索">
        ...
        <ul class="sidebar-menu" v-loading="this.loading">
              ...
              <li class="treeview" v-for="nav in this.navs">
                <a href="#">
                  <i class="fa fa-dashboard"></i> <span>{{ nav.display_name }}</span>
